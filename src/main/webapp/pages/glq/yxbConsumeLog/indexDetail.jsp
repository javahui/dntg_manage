...
<div id="div_right_frame">
	<div id="div_position_nav">当前位置：游戏日志 >> 游戏币消耗详细日志</div>
	...
	<table class="tbl_list">
		...
		<tr class="tr_list_data">	
			...
			<td class="center"> ${item.yxb}</td> 	
			<td class="center"> ${item.currentYxb}</td>						
		...
		<c:if test="${list.records == null} ">
			<tr class="tr_list_data"><td class="td_page_shift" colspan="6"><font color="red">由于数据量过大，请选择月份查询</font></td></tr>
		</c:if>
	</table>
	</div>
</div>
