...
<body>
	<div id="div_right_frame">
		<div id="div_position_nav">当前位置: 超级管理 >> 菜单管理 >> 列表</div>
		...
		<div class="div_operate">
			<ul>
				<li class="li_operate" onclick="window.location='addDir.do?isDir=1'">新增</li>
		...
		<table class="tbl_list">
			...
			<tr class="tr_list_data">
				...
				<td align="center">
					<a href="indexNode.do?id=${item.id}&actionName=${item.actionName}">查看节点列表</a>
