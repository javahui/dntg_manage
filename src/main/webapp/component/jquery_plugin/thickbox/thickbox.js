...
var tb_pathToImage = "component/jquery_plugin/thickbox/loadingAnimation.gif";
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			$("#TB_closeWindowButton").click(tb_remove);
				...
				if(url.indexOf('TB_inline') != -1){	
					var xx = document.getElementById("frame_content").contentWindow.document.getElementById("banner").contentWindow.document.getElementById(params['inlineId']);
					$("#TB_ajaxContent").append(xx.innerHTML);
