...
import com.lingyu.dntg.dao.glq.ConsumeYxbDetailDao;
 ...
 */
@Controller
@RequestMapping("yxbConsumeLog")
public class YxbConsumeLogAction extends AbstractAction{
	@Resource private ConsumeYxbDetailDao consumeYxbDetailDao;
	...
	public String index(String userName, String startTime,
		...
		if (StringUtils.isNotBlank(userName)
			...
			modelMap.put("list",logDaoTemplate.paging("yxbConsume.index", paramMap));
	...
	public String indexDetail(String month, HttpServletRequest request, ModelMap modelMap) {
		if (StringUtils.isNotBlank(month)) {
			Map paramMap = (Map) request.getAttribute("paramMap");
			modelMap.put("list", consumeYxbDetailDao.selectByMonth(month, paramMap));
		    modelMap.put("eventTypesList",paramMap.get("eventTypesList"));
		}
		modelMap.put("eventTypeMap2",StatisticsTaskGameEventTypeMapper.getRelateEventTypes(StatisticsTaskName.CONSUME_YXB));
		modelMap.put("eventTypeMap",GameLogEventType.getEventTypeMap());
