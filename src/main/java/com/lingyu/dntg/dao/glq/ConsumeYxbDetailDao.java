 ...
 */
@Component
public class ConsumeYxbDetailDao extends AbstractDao{
	...
	public PagingList selectByMonth(String month, Map paramMap){
		if (isExistTableByMonth(month)) {
			...
			return logDaoTemplate.paging("consumeYxbDetail.index", paramMap);
		}
		else{
	...
	public boolean isExistTableByMonth(String month){
		String result = logDaoTemplate.selectOne("consumeYxbDetail.existTableByMonth", month);
