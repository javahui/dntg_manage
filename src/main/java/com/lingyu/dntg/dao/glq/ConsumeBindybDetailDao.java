 ...
 */
@Component
public class ConsumeBindybDetailDao extends AbstractDao{
	...
	public PagingList selectByMonth(String month, Map paramMap){
		if (isExistTableByMonth(month)) {
			...
			return logDaoTemplate.paging("consumeBindybDetail.index", paramMap);
		}
		else{
	...
	public boolean isExistTableByMonth(String month){
		String result = logDaoTemplate.selectOne("consumeBindybDetail.existTableByMonth", month);
