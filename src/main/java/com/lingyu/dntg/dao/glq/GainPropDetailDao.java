 ...
 */
@Component
public class GainPropDetailDao extends AbstractDao{
	...
	public PagingList selectByMonth(String month, Map paramMap){
		if (isExistTableByMonth(month)) {
			...
			return logDaoTemplate.paging("gainPropDetail.index", paramMap);
		}
		else{
	...
	public boolean isExistTableByMonth(String month){
		String result = logDaoTemplate.selectOne("gainPropDetail.existTableByMonth", month);
