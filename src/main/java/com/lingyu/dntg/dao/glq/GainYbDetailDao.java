 ...
 */
@Component
public class GainYbDetailDao extends AbstractDao{
	...
	public PagingList selectByMonth(String month, Map paramMap){
		if (isExistTableByMonth(month)) {
			...
			return logDaoTemplate.paging("gainYbDetail.index", paramMap);
		}
		else{
	...
	public boolean isExistTableByMonth(String month){
		String result = logDaoTemplate.selectOne("gainYbDetail.existTableByMonth", month);
