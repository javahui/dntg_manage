 ...
 */
@Component
public class GainBindybDetailDao extends AbstractDao{
	...
	public PagingList selectByMonth(String month, Map paramMap){
		if (isExistTableByMonth(month)) {
			...
			return logDaoTemplate.paging("gainBindybDetail.index", paramMap);
		}
		else{
	...
	public boolean isExistTableByMonth(String month){
		String result = logDaoTemplate.selectOne("gainBindybDetail.existTableByMonth", month);
